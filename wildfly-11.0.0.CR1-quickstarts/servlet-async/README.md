...
The `servlet-async` quickstart is a sample project showing the use of asynchronous servlets in WildFly Application Server.
...
4. This will deploy `target/servlet-async.war` to the running instance of the server.
